...
// node_modules/chartjs-chart-box-and-violin-plot/node_modules/chart.js/dist/Chart.js
var require_Chart = __commonJS({
  "node_modules/chartjs-chart-box-and-violin-plot/node_modules/chart.js/dist/Chart.js"(exports, module2) {
    (function(global, factory) {
      ...
      var helpers2 = {
        ...
        valueAtIndexOrDefault: function(value, index, defaultValue) {
          return helpers2.valueOrDefault(helpers2.isArray(value) ? value[index] : value, defaultValue);
        },
        /**
        ...
        each: function(loopable, fn, thisArg, reverse) {
          ...
          } else if (helpers2.isObject(loopable)) {
        ...
        clone: function(source) {
          if (helpers2.isArray(source)) {
            return source.map(helpers2.clone);
          }
          if (helpers2.isObject(source)) {
            var target = Object.create(source);
            var keys2 = Object.keys(source);
            var klen = keys2.length;
            var k2 = 0;
            for (; k2 < klen; ++k2) {
              target[keys2[k2]] = helpers2.clone(source[keys2[k2]]);
            }
            return target;
          }
          return source;
        ...
        _merger: function(key, target, source, options2) {
          ...
          var tval = target[key];
          var sval = source[key];
          if (helpers2.isObject(tval) && helpers2.isObject(sval)) {
            helpers2.merge(tval, sval, options2);
          } else {
            target[key] = helpers2.clone(sval);
          }
        },
        /**
        ...
        merge: function(target, source, options2) {
          var sources = helpers2.isArray(source) ? source : [source];
          var ilen = sources.length;
          var merge, i, keys2, klen, k2;
          if (!helpers2.isObject(target)) {
            return target;
          }
          options2 = options2 || {};
          merge = options2.merger || helpers2._merger;
          for (i = 0; i < ilen; ++i) {
            source = sources[i];
            if (!helpers2.isObject(source)) {
              continue;
        ...
        mergeIf: function(target, source) {
          return helpers2.merge(target, source, { merger: helpers2._mergerIf });
        },
        /**
        ...
        extend: Object.assign || function(target) {
          return helpers2.merge(target, [].slice.call(arguments, 1), {
        ...
        inherits: function(extensions) {
          ...
          ChartElement.extend = helpers2.inherits;
          if (extensions) {
            helpers2.extend(ChartElement.prototype, extensions);
          }
      ...
      var helpers_core = helpers2;
      helpers2.callCallback = helpers2.callback;
      helpers2.indexOf = function(array2, item, fromIndex) {
        return Array.prototype.indexOf.call(array2, item, fromIndex);
      };
      helpers2.getValueOrDefault = helpers2.valueOrDefault;
      helpers2.getValueAtIndexOrDefault = helpers2.valueAtIndexOrDefault;
      var effects = {
        linear: function(t) {
          return t;
        },
      ...
      var exports$1 = {
         ...
         */
        roundedRect: function(ctx, x, y, width, height4, radius) {
          if (radius) {
            var r = Math.min(radius, height4 / 2, width / 2);
            var left = x + r;
            var top = y + r;
            var right = x + width - r;
            var bottom = y + height4 - r;
            ctx.moveTo(x, top);
      ...
      var helpers$12 = helpers_core;
      var easing = helpers_easing;
      var canvas = helpers_canvas;
      var options = helpers_options;
      var math = helpers_math;
      var rtl = helpers_rtl;
      helpers$12.easing = easing;
      helpers$12.canvas = canvas;
      helpers$12.options = options;
      helpers$12.math = math;
      helpers$12.rtl = rtl;
      function interpolate(start, view, model, ease) {
        ...
        for (i = 0, ilen = keys2.length; i < ilen; ++i) {
          ...
          if (type === typeof origin) {
            ...
            } else if (helpers$12.isFinite(origin) && helpers$12.isFinite(target)) {
      ...
      var Element2 = function(configuration) {
        helpers$12.extend(this, configuration);
        this.initialize.apply(this, arguments);
      };
      helpers$12.extend(Element2.prototype, {
        _type: void 0,
        initialize: function() {
          this.hidden = false;
        },
        pivot: function() {
          var me = this;
          if (!me._view) {
            me._view = helpers$12.extend({}, me._model);
          }
          me._start = {};
          return me;
        },
        transition: function(ease) {
          ...
          var view = me._view;
          if (!model || ease === 1) {
            me._view = helpers$12.extend({}, model);
            me._start = null;
            return me;
          }
          if (!view) {
        ...
        hasValue: function() {
          return helpers$12.isNumber(this._model.x) && helpers$12.isNumber(this._model.y);
        }
      });
      Element2.extend = helpers$12.inherits;
      ...
      core_defaults._set("global", {
        animation: {
          duration: 1e3,
          easing: "easeOutQuart",
          onProgress: helpers$12.noop,
          onComplete: helpers$12.noop
        }
      });
      var core_animations = {
        animations: [],
        ...
        cancelAnimation: function(chart) {
          var index = helpers$12.findIndex(this.animations, function(animation) {
        ...
        requestAnimationFrame: function() {
          var me = this;
          if (me.request === null) {
            me.request = helpers$12.requestAnimFrame.call(window, function() {
              me.request = null;
              me.startDigest();
            });
          }
        ...
        advance: function() {
          ...
          while (i < animations.length) {
            ...
            helpers$12.callback(animation.render, [chart, animation], chart);
            helpers$12.callback(animation.onAnimationProgress, [animation], chart);
            if (animation.currentStep >= numSteps) {
              helpers$12.callback(animation.onAnimationComplete, [animation], chart);
              chart.animating = false;
      ...
      var resolve = helpers$12.options.resolve;
        ...
        arrayEvents.forEach(function(key) {
          ...
          Object.defineProperty(array2, key, {
            ...
            value: function() {
              ...
              helpers$12.each(array2._chartjs.listeners, function(object) {
      ...
      helpers$12.extend(DatasetController.prototype, {
        /**
        ...
        _configure: function() {
          var me = this;
          me._config = helpers$12.merge(/* @__PURE__ */ Object.create(null), [
            me.chart.options.datasets[me._type],
            me.getDataset()
          ], {
            merger: function(key, target, source) {
              if (key !== "_meta" && key !== "data") {
                helpers$12._merger(key, target, source);
              }
            }
          });
        },
        ...
        update: helpers$12.noop,
        transition: function(easingValue) {
          var meta = this.getMeta();
          var elements3 = meta.data || [];
          var ilen = elements3.length;
          var i = 0;
          for (; i < ilen; ++i) {
            elements3[i].transition(easingValue);
          }
          if (meta.dataset) {
        ...
        _resolveDataElementOptions: function(element, index) {
          ...
          custom = custom || {};
          if (helpers$12.isArray(elementOptions)) {
            for (i = 0, ilen = elementOptions.length; i < ilen; ++i) {
              key = elementOptions[i];
              values[key] = resolve([
                custom[key],
        ...
        removeHoverStyle: function(element) {
          helpers$12.merge(element._model, element.$previousStyle || {});
        ...
        setHoverStyle: function(element) {
          ...
          var getHoverColor = helpers$12.getHoverColor;
      ...
      DatasetController.extend = helpers$12.inherits;
      ...
      var element_arc = core_element.extend({
        ...
        inRange: function(chartX, chartY) {
          var vm = this._view;
          if (vm) {
            var pointRelativePosition = helpers$12.getAngleFromPoint(vm, { x: chartX, y: chartY });
      ...
      var valueOrDefault$1 = helpers$12.valueOrDefault;
        ...
        draw: function() {
          ...
          if (me._loop) {
            for (index = 0; index < points.length; ++index) {
              previous = helpers$12.previousItem(points, index);
          ...
          for (index = 1; index < points.length; ++index) {
            ...
            previous = lastDrawnIndex === -1 ? helpers$12.previousItem(points, index) : points[lastDrawnIndex];
            if (!currentVM.skip) {
              if (lastDrawnIndex !== index - 1 && !spanGaps || lastDrawnIndex === -1) {
                ctx.moveTo(currentVM.x, currentVM.y);
              } else {
                helpers$12.canvas.lineTo(ctx, previous._view, currentVM);
              }
      ...
      var valueOrDefault$2 = helpers$12.valueOrDefault;
      ...
      var element_point = core_element.extend({
        ...
        draw: function(chartArea) {
          ...
          if (chartArea === void 0 || helpers$12.canvas._isPointInArea(vm, chartArea)) {
            ctx.strokeStyle = vm.borderColor || defaultColor2;
            ctx.lineWidth = valueOrDefault$2(vm.borderWidth, globalDefaults.elements.point.borderWidth);
            ctx.fillStyle = vm.backgroundColor || defaultColor2;
            helpers$12.canvas.drawPoint(ctx, pointStyle, radius, x, y, rotation);
          }
        }
      });
      ...
      function boundingRects(vm) {
        ...
        var height4 = bounds.bottom - bounds.top;
        var border = parseBorderWidth(vm, width / 2, height4 / 2);
        return {
          outer: {
            x: bounds.left,
            y: bounds.top,
          ...
          inner: {
            ...
            h: height4 - border.t - border.b
          }
        };
      }
      function inRange2(vm, x, y) {
        var skipX = x === null;
        var skipY = y === null;
      ...
      var element_rectangle = core_element.extend({
        ...
        inRange: function(mouseX, mouseY) {
          return inRange2(this._view, mouseX, mouseY);
        },
        inLabelRange: function(mouseX, mouseY) {
          var vm = this._view;
          return isVertical2(vm) ? inRange2(vm, mouseX, null) : inRange2(vm, null, mouseY);
        },
        inXRange: function(mouseX) {
          return inRange2(this._view, mouseX, null);
        },
        inYRange: function(mouseY) {
          return inRange2(this._view, null, mouseY);
        },
        getCenterPoint: function() {
          var vm = this._view;
          var x, y;
        ...
        getArea: function() {
          var vm = this._view;
          return isVertical2(vm) ? vm.width * Math.abs(vm.y - vm.base) : vm.height * Math.abs(vm.x - vm.base);
        },
        tooltipPosition: function() {
          var vm = this._view;
          return {
      ...
      elements2.Arc = Arc;
      elements2.Line = Line;
      elements2.Point = Point;
      elements2.Rectangle = Rectangle;
      var deprecated = helpers$12._deprecated;
      var valueOrDefault$3 = helpers$12.valueOrDefault;
      ...
      function computeFitCategoryTraits(index, ruler, options2) {
        ...
        var min2 = helpers$12.isNullOrUndef(thickness) ? computeMinSampleSize(ruler.scale, ruler.pixels) : -1;
        var size, ratio;
        if (helpers$12.isNullOrUndef(thickness)) {
      ...
      var controller_bar = core_datasetController.extend({
        dataElementType: elements2.Rectangle,
        /**
         * @private
         */
        _dataElementOptions: [
        ...
        updateElement: function(rectangle, index, reset) {
          ...
          if (helpers$12.isArray(dataset.data[index])) {
        ...
        draw: function() {
          ...
          var i = 0;
          helpers$12.canvas.clipArea(chart.ctx, chart.chartArea);
          for (; i < ilen; ++i) {
          ...
          helpers$12.canvas.unclipArea(chart.ctx);
        },
        /**
         * @private
         */
        _resolveDataElementOptions: function() {
          var me = this;
          var values = helpers$12.extend({}, core_datasetController.prototype._resolveDataElementOptions.apply(me, arguments));
      ...
      var valueOrDefault$4 = helpers$12.valueOrDefault;
      var resolve$1 = helpers$12.options.resolve;
      ...
      var controller_bubble = core_datasetController.extend({
         ...
         * @protected
         */
        dataElementType: elements2.Point,
        /**
         * @private
         */
        _dataElementOptions: [
        ...
        update: function(reset) {
          ...
          helpers$12.each(points, function(point, index) {
        ...
        _resolveDataElementOptions: function(point, index) {
          ...
          if (me._cachedDataOpts === values) {
            values = helpers$12.extend({}, values);
          }
      ...
      var valueOrDefault$5 = helpers$12.valueOrDefault;
      var PI$1 = Math.PI;
        ...
        tooltips: {
          callbacks: {
            ...
            label: function(tooltipItem, data) {
              ...
              if (helpers$12.isArray(dataLabel)) {
      ...
      var controller_doughnut = core_datasetController.extend({
        dataElementType: elements2.Arc,
        linkScales: helpers$12.noop,
        /**
         * @private
         */
        _dataElementOptions: [
        ...
        updateElement: function(arc, index, reset) {
          ...
          helpers$12.extend(arc, {
            ...
            _model: {
              ...
              outerRadius,
              innerRadius,
              label: helpers$12.valueAtIndexOrDefault(dataset.label, index, chart.data.labels[index])
            }
          });
        ...
        calculateTotal: function() {
          ...
          var total = 0;
          var value;
          helpers$12.each(meta.data, function(element, index) {
        ...
        getMaxBorderWidth: function(arcs) {
          ...
          var max2 = 0;
          var chart = me.chart;
          var i, ilen, meta, arc, controller2, options2, borderWidth, hoverWidth;
          if (!arcs) {
            for (i = 0, ilen = chart.data.datasets.length; i < ilen; ++i) {
          ...
          for (i = 0, ilen = arcs.length; i < ilen; ++i) {
            arc = arcs[i];
            if (controller2) {
              controller2._configure();
              options2 = controller2._resolveDataElementOptions(arc, i);
            } else {
      ...
      var valueOrDefault$6 = helpers$12.valueOrDefault;
      var resolve$2 = helpers$12.options.resolve;
      var isPointInArea = helpers$12.canvas._isPointInArea;
      ...
      var controller_line = core_datasetController.extend({
        datasetElementType: elements2.Line,
        dataElementType: elements2.Point,
        /**
         * @private
         */
        ...
        updateBezierControlPoints: function() {
          ...
          if (lineModel.cubicInterpolationMode === "monotone") {
            helpers$12.splineCurveMonotone(points);
          } else {
            for (i = 0, ilen = points.length; i < ilen; ++i) {
              model = points[i]._model;
              controlPoints = helpers$12.splineCurve(
                helpers$12.previousItem(points, i)._model,
                model,
                helpers$12.nextItem(points, i)._model,
                lineModel.tension
              );
        ...
        draw: function() {
          ...
          if (me._showLine) {
            ...
            helpers$12.canvas.clipArea(chart.ctx, {
      ...
      var resolve$3 = helpers$12.options.resolve;
      ...
      var controller_polarArea = core_datasetController.extend({
        ...
        updateElement: function(arc, index, reset) {
          ...
          helpers$12.extend(arc, {
            ...
            _model: {
              ...
              label: helpers$12.valueAtIndexOrDefault(labels, index, labels[index])
            }
          });
          arc.pivot();
        },
        ...
        setHoverStyle: function(arc) {
          ...
          var options2 = arc._options;
          var getHoverColor = helpers$12.getHoverColor;
          var valueOrDefault2 = helpers$12.valueOrDefault;
          arc.$previousStyle = {
            backgroundColor: model.backgroundColor,
            borderColor: model.borderColor,
            borderWidth: model.borderWidth
      ...
      core_defaults._set("pie", helpers$12.clone(core_defaults.doughnut));
      core_defaults._set("pie", {
        cutoutPercentage: 0
      });
      var controller_pie = controller_doughnut;
      var valueOrDefault$7 = helpers$12.valueOrDefault;
      ...
      var controller_radar = core_datasetController.extend({
        ...
        updateBezierControlPoints: function() {
          ...
          for (i = 0, ilen = points.length; i < ilen; ++i) {
            model = points[i]._model;
            controlPoints = helpers$12.splineCurve(
              helpers$12.previousItem(points, i, true)._model,
              model,
              helpers$12.nextItem(points, i, true)._model,
              model.tension
            );
      ...
      function getRelativePosition(e, chart) {
        ...
        return helpers$12.getRelativePosition(e, chart);
      }
      ...
      var extend2 = helpers$12.extend;
      function filterByPosition(array2, position) {
        return helpers$12.where(array2, function(v) {
      ...
      var core_layouts = {
         ...
         */
        update: function(chart, width, height4) {
          if (!chart) {
            return;
          }
          var layoutOptions = chart.options.layout || {};
          var padding = helpers$12.options.toPadding(layoutOptions.padding);
          var availableWidth = width - padding.width;
          var availableHeight = height4 - padding.height;
          ...
          helpers$12.each(boxes.chartArea, function(layout) {
            var box = layout.box;
      ...
      function readUsedSize(element, property) {
        var value = helpers$12.getStyle(element, property);
      ...
      function fromNativeEvent(event, chart) {
        ...
        var pos = helpers$12.getRelativePosition(event, chart);
      ...
      function throttled(fn, thisArg) {
        ...
        return function() {
          ...
          if (!ticking) {
            ticking = true;
            helpers$12.requestAnimFrame.call(window, function() {
              ticking = false;
      ...
      function watchForRender(node, handler) {
        ...
        helpers$12.each(ANIMATION_START_EVENTS, function(type) {
      ...
      var platform_dom$2 = {
        ...
        releaseContext: function(context) {
          ...
          ["height", "width"].forEach(function(prop) {
            ...
            if (helpers$12.isNullOrUndef(value)) {
              canvas2.removeAttribute(prop);
            } else {
              canvas2.setAttribute(prop, value);
            }
          });
          helpers$12.each(initial.style || {}, function(value, key) {
      ...
      helpers$12.addEvent = addListener;
      helpers$12.removeEvent = removeListener;
      var implementation = platform_dom$2._enabled ? platform_dom$2 : platform_basic;
      var platform = helpers$12.extend({
        /**
         * @since 2.7.0
         */
        initialize: function() {
      ...
      var core_plugins = {
        ...
        descriptors: function(chart) {
          ...
          this._plugins.concat(config.plugins || []).forEach(function(plugin) {
            ...
            if (opts === true) {
              opts = helpers$12.clone(core_defaults.global.plugins[id]);
            }
      ...
      var core_scaleService = {
        ...
        registerScaleType: function(type, scaleConstructor, scaleDefaults) {
          ...
          this.defaults[type] = helpers$12.clone(scaleDefaults);
        },
        getScaleConstructor: function(type) {
          return this.constructors.hasOwnProperty(type) ? this.constructors[type] : void 0;
        },
        getScaleDefaults: function(type) {
          return this.defaults.hasOwnProperty(type) ? helpers$12.merge(/* @__PURE__ */ Object.create(null), [core_defaults.scale, this.defaults[type]]) : {};
        },
        updateScaleDefaults: function(type, additions) {
          var me = this;
          if (me.defaults.hasOwnProperty(type)) {
            me.defaults[type] = helpers$12.extend(me.defaults[type], additions);
          }
        },
        addScalesToLayout: function(chart) {
          helpers$12.each(chart.scales, function(scale2) {
      ...
      var valueOrDefault$8 = helpers$12.valueOrDefault;
      var getRtlHelper = helpers$12.rtl.getRtlAdapter;
      core_defaults._set("global", {
        tooltips: {
          enabled: true,
          custom: null,
          ...
          callbacks: {
            ...
            afterTitle: helpers$12.noop,
            // Args are: (tooltipItems, data)
            beforeBody: helpers$12.noop,
            // Args are: (tooltipItem, data)
            beforeLabel: helpers$12.noop,
            label: function(tooltipItem, data) {
              var label = data.datasets[tooltipItem.datasetIndex].label || "";
              if (label) {
                label += ": ";
              }
              if (!helpers$12.isNullOrUndef(tooltipItem.value)) {
            ...
            afterLabel: helpers$12.noop,
            // Args are: (tooltipItems, data)
            afterBody: helpers$12.noop,
            // Args are: (tooltipItems, data)
            beforeFooter: helpers$12.noop,
            footer: helpers$12.noop,
            afterFooter: helpers$12.noop
          }
        }
      });
      var positioners = {
         ...
         */
        nearest: function(elements3, eventPosition) {
          ...
          for (i = 0, len = elements3.length; i < len; ++i) {
            ...
            if (el && el.hasValue()) {
              ...
              var d = helpers$12.distanceBetweenPoints(eventPosition, center);
              if (d < minDistance) {
                minDistance = d;
                nearestElement = el;
              }
      ...
      function createTooltipItem(element) {
        ...
        var controller2 = element._chart.getDatasetMeta(datasetIndex).controller;
        var indexScale = controller2._getIndexScale();
        var valueScale = controller2._getValueScale();
        return {
      ...
      function getTooltipSize(tooltip, model) {
        ...
        height4 += titleLineCount * titleFontSize;
        height4 += titleLineCount ? (titleLineCount - 1) * model.titleSpacing : 0;
        height4 += titleLineCount ? model.titleMarginBottom : 0;
        height4 += combinedBodyLength * bodyFontSize;
        height4 += combinedBodyLength ? (combinedBodyLength - 1) * model.bodySpacing : 0;
        height4 += footerLineCount ? model.footerMarginTop : 0;
        height4 += footerLineCount * footerFontSize;
        height4 += footerLineCount ? (footerLineCount - 1) * model.footerSpacing : 0;
        var widthPadding = 0;
        var maxLineWidth = function(line) {
          width = Math.max(width, ctx.measureText(line).width + widthPadding);
        };
        ctx.font = helpers$12.fontString(titleFontSize, model._titleFontStyle, model._titleFontFamily);
        helpers$12.each(model.title, maxLineWidth);
        ctx.font = helpers$12.fontString(bodyFontSize, model._bodyFontStyle, model._bodyFontFamily);
        helpers$12.each(model.beforeBody.concat(model.afterBody), maxLineWidth);
        widthPadding = model.displayColors ? bodyFontSize + 2 : 0;
        helpers$12.each(body, function(bodyItem) {
          helpers$12.each(bodyItem.before, maxLineWidth);
          helpers$12.each(bodyItem.lines, maxLineWidth);
          helpers$12.each(bodyItem.after, maxLineWidth);
        });
        widthPadding = 0;
        ctx.font = helpers$12.fontString(footerFontSize, model._footerFontStyle, model._footerFontFamily);
        helpers$12.each(model.footer, maxLineWidth);
      ...
      var exports$4 = core_element.extend({
        ...
        getBody: function(tooltipItems, data) {
          ...
          var bodyItems = [];
          helpers$12.each(tooltipItems, function(tooltipItem) {
            var bodyItem = {
              before: [],
              lines: [],
              after: []
        ...
        update: function(changed) {
          ...
          if (active.length) {
            ...
            var labelColors = [];
            var labelTextColors = [];
            tooltipPosition2 = positioners[opts.position].call(me, active, me._eventPosition);
            var tooltipItems = [];
            ...
            model.x = tooltipPosition2.x;
            model.y = tooltipPosition2.y;
          ...
          model.caretX = tooltipPosition2.x;
          model.caretY = tooltipPosition2.y;
          me._model = model;
        ...
        drawTitle: function(pt, vm, ctx) {
          ...
          if (length) {
            ...
            ctx.font = helpers$12.fontString(titleFontSize, vm._titleFontStyle, vm._titleFontFamily);
            for (i = 0; i < length; ++i) {
        ...
        drawBody: function(pt, vm, ctx) {
          ...
          ctx.textBaseline = "middle";
          ctx.font = helpers$12.fontString(bodyFontSize, vm._bodyFontStyle, vm._bodyFontFamily);
          pt.x = getAlignedX(vm, bodyAlignForCalculation);
          ctx.fillStyle = vm.bodyFontColor;
          helpers$12.each(vm.beforeBody, fillLineOfText);
          ...
          for (i = 0, ilen = body.length; i < ilen; ++i) {
            ...
            helpers$12.each(bodyItem.before, fillLineOfText);
            ...
            helpers$12.each(bodyItem.after, fillLineOfText);
          }
          xLinePadding = 0;
          helpers$12.each(vm.afterBody, fillLineOfText);
          pt.y -= bodySpacing;
        },
        drawFooter: function(pt, vm, ctx) {
          ...
          if (length) {
            ...
            ctx.font = helpers$12.fontString(footerFontSize, vm._footerFontStyle, vm._footerFontFamily);
            for (i = 0; i < length; ++i) {
        ...
        drawBackground: function(pt, vm, ctx, tooltipSize) {
          ...
          var height4 = tooltipSize.height;
          ...
          ctx.lineTo(x + width, y + height4 - radius);
          ctx.quadraticCurveTo(x + width, y + height4, x + width - radius, y + height4);
          if (yAlign === "bottom") {
            this.drawCaret(pt, tooltipSize);
          }
          ctx.lineTo(x + radius, y + height4);
          ctx.quadraticCurveTo(x, y + height4, x, y + height4 - radius);
        ...
        draw: function() {
          ...
          if (this._options.enabled && hasTooltipContent) {
            ...
            pt.y += vm.yPadding;
            helpers$12.rtl.overrideTextDirection(ctx, vm.textDirection);
            this.drawTitle(pt, vm, ctx);
            this.drawBody(pt, vm, ctx);
            this.drawFooter(pt, vm, ctx);
            helpers$12.rtl.restoreTextDirection(ctx, vm.textDirection);
            ctx.restore();
          }
        },
        /**
        ...
        handleEvent: function(e) {
          ...
          changed = !helpers$12.arrayEquals(me._active, me._lastActive);
          if (changed) {
      ...
      var valueOrDefault$9 = helpers$12.valueOrDefault;
      core_defaults._set("global", {
        elements: {},
        events: [
          "mousemove",
      ...
      function mergeScaleConfig() {
        return helpers$12.merge(/* @__PURE__ */ Object.create(null), [].slice.call(arguments), {
            ...
            if (key === "xAxes" || key === "yAxes") {
              ...
              for (i = 0; i < slen; ++i) {
                ...
                if (!target[key][i].type || scale2.type && scale2.type !== target[key][i].type) {
                  helpers$12.merge(target[key][i], [core_scaleService.getScaleDefaults(type), scale2]);
                } else {
                  helpers$12.merge(target[key][i], scale2);
                }
              }
            } else {
              helpers$12._merger(key, target, source, options2);
            }
          }
        });
      }
        ...
        return helpers$12.merge(/* @__PURE__ */ Object.create(null), [].slice.call(arguments), {
          merger: function(key, target, source, options2) {
            ...
            if (key === "scales") {
              ...
              target[key] = helpers$12.merge(tval, [core_scaleService.getScaleDefaults(sval.type), sval]);
            } else {
              helpers$12._merger(key, target, source, options2);
            }
          }
      ...
      function nextAvailableScaleId(axesOpts, prefix, index) {
        ...
        do {
          id = prefix + index++;
        } while (helpers$12.findIndex(axesOpts, hasId) >= 0);
        return id;
      }
      ...
      helpers$12.extend(
        ...
        /** @lends Chart */
        {
          ...
          construct: function(item, config) {
            ...
            var height4 = canvas2 && canvas2.height;
            var width = canvas2 && canvas2.width;
            me.id = helpers$12.uid();
            me.ctx = context;
            me.canvas = canvas2;
            me.config = config;
            me.width = width;
            me.height = height4;
            me.aspectRatio = height4 ? width / height4 : null;
          ...
          initialize: function() {
            ...
            helpers$12.retinaScale(me, me.options.devicePixelRatio);
            me.bindEvents();
          ...
          resize: function(silent) {
            ...
            var newWidth = Math.max(0, Math.floor(helpers$12.getMaximumWidth(canvas2)));
            var newHeight = Math.max(0, Math.floor(aspectRatio ? newWidth / aspectRatio : helpers$12.getMaximumHeight(canvas2)));
            ...
            helpers$12.retinaScale(me, options2.devicePixelRatio);
            if (!silent) {
          ...
          ensureScalesHaveIDs: function() {
            ...
            helpers$12.each(scalesOptions.xAxes, function(xAxisOptions, index) {
              if (!xAxisOptions.id) {
                xAxisOptions.id = nextAvailableScaleId(scalesOptions.xAxes, "x-axis-", index);
              }
            });
            helpers$12.each(scalesOptions.yAxes, function(yAxisOptions, index) {
              if (!yAxisOptions.id) {
          ...
          buildOrUpdateScales: function() {
            ...
            helpers$12.each(items, function(item) {
            ...
            helpers$12.each(updated, function(hasUpdated, id) {
              if (!hasUpdated) {
                delete scales2[id];
              }
            });
          ...
          buildOrUpdateControllers: function() {
            ...
            for (i = 0, ilen = datasets.length; i < ilen; i++) {
              ...
              if (meta.controller) {
                ...
                var ControllerClass = controllers2[meta.type];
          ...
          resetElements: function() {
            var me = this;
            helpers$12.each(me.data.datasets, function(dataset, datasetIndex) {
          ...
          */
          ...
          update: function(config) {
            ...
            if (me.options.animation && me.options.animation.duration) {
              helpers$12.each(newControllers, function(controller2) {
                controller2.reset();
              });
            }
            me.updateDatasets();
          ...
          updateLayout: function() {
            ...
            me._layers = [];
            helpers$12.each(me.boxes, function(box) {
              if (box._configure) {
                box._configure();
              }
          ...
          render: function(config) {
            ...
            var onComplete = function(animation2) {
              ...
              helpers$12.callback(animationOptions && animationOptions.onComplete, [animation2], me);
            };
            if (animationOptions && duration) {
              var animation = new core_animation({
                ...
                render: function(chart, animationObject) {
                  var easingFunction = helpers$12.easing.effects[animationObject.easing];
          ...
          draw: function(easingValue) {
            ...
            var i, layers;
            me.clear();
            if (helpers$12.isNullOrUndef(easingValue)) {
              easingValue = 1;
            }
          ...
          bindEvents: function() {
            ...
            helpers$12.each(me.options.events, function(type) {
          ...
          unbindEvents: function() {
            ...
            helpers$12.each(listeners, function(listener, type) {
              platform.removeEventListener(me, type, listener);
            });
          },
          updateHoverStyle: function(elements3, mode, enabled) {
            var prefix = enabled ? "set" : "remove";
            var element, i, ilen;
            for (i = 0, ilen = elements3.length; i < ilen; ++i) {
              element = elements3[i];
              if (element) {
            ...
            if (mode === "dataset") {
              this.getDatasetMeta(elements3[0]._datasetIndex).controller["_" + prefix + "DatasetHoverStyle"]();
            }
          },
          /**
           * @private
          ...
          handleEvent: function(e) {
            ...
            helpers$12.callback(options2.onHover || options2.hover.onHover, [e.native, me.active], me);
            ...
            changed = !helpers$12.arrayEquals(me.active, me.lastActive);
      ...
      Chart.types = {};
      helpers$12.configMerge = mergeConfig;
      helpers$12.scaleMerge = mergeScaleConfig;
      var core_helpers = function() {
        helpers$12.where = function(collection, filterCallback) {
          if (helpers$12.isArray(collection) && Array.prototype.filter) {
            return collection.filter(filterCallback);
          }
          var filtered = [];
          helpers$12.each(collection, function(item) {
        ...
        helpers$12.findIndex = Array.prototype.findIndex ? function(array2, callback, scope) {
          return array2.findIndex(callback, scope);
        } : function(array2, callback, scope) {
          scope = scope === void 0 ? array2 : scope;
          for (var i = 0, ilen = array2.length; i < ilen; ++i) {
            if (callback.call(scope, array2[i], i, array2)) {
              return i;
            }
          }
          return -1;
        };
        helpers$12.findNextWhere = function(arrayToSearch, filterCallback, startIndex) {
          if (helpers$12.isNullOrUndef(startIndex)) {
            startIndex = -1;
          }
        ...
        helpers$12.findPreviousWhere = function(arrayToSearch, filterCallback, startIndex) {
          if (helpers$12.isNullOrUndef(startIndex)) {
        ...
        helpers$12.isNumber = function(n) {
          return !isNaN(parseFloat(n)) && isFinite(n);
        };
        helpers$12.almostEquals = function(x, y, epsilon) {
          return Math.abs(x - y) < epsilon;
        };
        helpers$12.almostWhole = function(x, epsilon) {
          var rounded = Math.round(x);
          return rounded - epsilon <= x && rounded + epsilon >= x;
        };
        helpers$12.max = function(array2) {
          return array2.reduce(function(max2, value) {
            if (!isNaN(value)) {
        ...
        helpers$12.min = function(array2) {
          return array2.reduce(function(min2, value) {
            if (!isNaN(value)) {
        ...
        helpers$12.sign = Math.sign ? function(x) {
          return Math.sign(x);
        } : function(x) {
          x = +x;
          if (x === 0 || isNaN(x)) {
        ...
        helpers$12.toRadians = function(degrees) {
          return degrees * (Math.PI / 180);
        };
        helpers$12.toDegrees = function(radians) {
          return radians * (180 / Math.PI);
        };
        helpers$12._decimalPlaces = function(x) {
          if (!helpers$12.isFinite(x)) {
            return;
          }
          var e = 1;
          var p = 0;
        ...
        helpers$12.getAngleFromPoint = function(centrePoint, anglePoint) {
        ...
        helpers$12.distanceBetweenPoints = function(pt1, pt2) {
          return Math.sqrt(Math.pow(pt2.x - pt1.x, 2) + Math.pow(pt2.y - pt1.y, 2));
        };
        helpers$12.aliasPixel = function(pixelWidth) {
          return pixelWidth % 2 === 0 ? 0 : 0.5;
        };
        helpers$12._alignPixel = function(chart, pixel, width) {
          var devicePixelRatio = chart.currentDevicePixelRatio;
          var halfWidth = width / 2;
          return Math.round((pixel - halfWidth) * devicePixelRatio) / devicePixelRatio + halfWidth;
        };
        helpers$12.splineCurve = function(firstPoint, middlePoint, afterPoint, t) {
        ...
        helpers$12.EPSILON = Number.EPSILON || 1e-14;
        helpers$12.splineCurveMonotone = function(points) {
          ...
          for (i = 0; i < pointsLen - 1; ++i) {
            ...
            if (helpers$12.almostEquals(pointCurrent.deltaK, 0, this.EPSILON)) {
        ...
        helpers$12.nextItem = function(collection, index, loop) {
          if (loop) {
            return index >= collection.length - 1 ? collection[0] : collection[index + 1];
          }
          return index >= collection.length - 1 ? collection[collection.length - 1] : collection[index + 1];
        };
        helpers$12.previousItem = function(collection, index, loop) {
          if (loop) {
            return index <= 0 ? collection[collection.length - 1] : collection[index - 1];
          }
          return index <= 0 ? collection[0] : collection[index - 1];
        };
        helpers$12.niceNum = function(range, round2) {
          var exponent = Math.floor(helpers$12.log10(range));
        ...
        helpers$12.requestAnimFrame = function() {
          if (typeof window === "undefined") {
        ...
        helpers$12.getRelativePosition = function(evt, chart) {
          var mouseX, mouseY;
          ...
          var paddingLeft = parseFloat(helpers$12.getStyle(canvas2, "padding-left"));
          var paddingTop = parseFloat(helpers$12.getStyle(canvas2, "padding-top"));
          var paddingRight = parseFloat(helpers$12.getStyle(canvas2, "padding-right"));
          var paddingBottom = parseFloat(helpers$12.getStyle(canvas2, "padding-bottom"));
          var width = boundingRect.right - boundingRect.left - paddingLeft - paddingRight;
          var height4 = boundingRect.bottom - boundingRect.top - paddingTop - paddingBottom;
          mouseX = Math.round((mouseX - boundingRect.left - paddingLeft) / width * canvas2.width / chart.currentDevicePixelRatio);
          mouseY = Math.round((mouseY - boundingRect.top - paddingTop) / height4 * canvas2.height / chart.currentDevicePixelRatio);
          return {
            x: mouseX,
            y: mouseY
          };
        ...
        function getConstraintDimension(domNode, maxStyle, percentageProperty) {
          ...
          var parentNode = helpers$12._getParentNode(domNode);
        ...
        helpers$12.getConstraintWidth = function(domNode) {
          return getConstraintDimension(domNode, "max-width", "clientWidth");
        };
        helpers$12.getConstraintHeight = function(domNode) {
          return getConstraintDimension(domNode, "max-height", "clientHeight");
        };
        helpers$12._calculatePadding = function(container, padding, parentDimension) {
          padding = helpers$12.getStyle(container, padding);
          return padding.indexOf("%") > -1 ? parentDimension * parseInt(padding, 10) / 100 : parseInt(padding, 10);
        };
        helpers$12._getParentNode = function(domNode) {
        ...
        helpers$12.getMaximumWidth = function(domNode) {
          var container = helpers$12._getParentNode(domNode);
          if (!container) {
            return domNode.clientWidth;
          }
          var clientWidth = container.clientWidth;
          var paddingLeft = helpers$12._calculatePadding(container, "padding-left", clientWidth);
          var paddingRight = helpers$12._calculatePadding(container, "padding-right", clientWidth);
          var w = clientWidth - paddingLeft - paddingRight;
          var cw = helpers$12.getConstraintWidth(domNode);
          return isNaN(cw) ? w : Math.min(w, cw);
        };
        helpers$12.getMaximumHeight = function(domNode) {
          var container = helpers$12._getParentNode(domNode);
          if (!container) {
            return domNode.clientHeight;
          }
          var clientHeight = container.clientHeight;
          var paddingTop = helpers$12._calculatePadding(container, "padding-top", clientHeight);
          var paddingBottom = helpers$12._calculatePadding(container, "padding-bottom", clientHeight);
          var h = clientHeight - paddingTop - paddingBottom;
          var ch = helpers$12.getConstraintHeight(domNode);
          return isNaN(ch) ? h : Math.min(h, ch);
        };
        helpers$12.getStyle = function(el, property) {
          return el.currentStyle ? el.currentStyle[property] : document.defaultView.getComputedStyle(el, null).getPropertyValue(property);
        };
        helpers$12.retinaScale = function(chart, forceRatio) {
          var pixelRatio = chart.currentDevicePixelRatio = forceRatio || typeof window !== "undefined" && window.devicePixelRatio || 1;
          if (pixelRatio === 1) {
            return;
          }
          var canvas2 = chart.canvas;
          var height4 = chart.height;
          var width = chart.width;
          canvas2.height = height4 * pixelRatio;
          canvas2.width = width * pixelRatio;
          chart.ctx.scale(pixelRatio, pixelRatio);
          if (!canvas2.style.height && !canvas2.style.width) {
            canvas2.style.height = height4 + "px";
            canvas2.style.width = width + "px";
          }
        };
        helpers$12.fontString = function(pixelSize, fontStyle, fontFamily) {
          return fontStyle + " " + pixelSize + "px " + fontFamily;
        };
        helpers$12.longestText = function(ctx, font, arrayOfThings, cache) {
          cache = cache || {};
          ...
          for (i = 0; i < ilen; i++) {
            ...
            if (thing !== void 0 && thing !== null && helpers$12.isArray(thing) !== true) {
              longest = helpers$12.measureText(ctx, data, gc, longest, thing);
            } else if (helpers$12.isArray(thing)) {
              for (j = 0, jlen = thing.length; j < jlen; j++) {
                nestedThing = thing[j];
                if (nestedThing !== void 0 && nestedThing !== null && !helpers$12.isArray(nestedThing)) {
                  longest = helpers$12.measureText(ctx, data, gc, longest, nestedThing);
                }
              }
            }
          }
        ...
        helpers$12.measureText = function(ctx, data, gc, longest, string) {
        ...
        helpers$12.numberOfLabelLines = function(arrayOfThings) {
          var numberOfLines = 1;
          helpers$12.each(arrayOfThings, function(thing) {
            if (helpers$12.isArray(thing)) {
        ...
        helpers$12.color = !chartjsColor ? function(value) {
        ...
        helpers$12.getHoverColor = function(colorValue) {
          return colorValue instanceof CanvasPattern || colorValue instanceof CanvasGradient ? colorValue : helpers$12.color(colorValue).saturate(0.5).darken(0.1).rgbString();
        };
      };
      function abstract() {
        throw new Error(
      ...
      DateAdapter.override = function(members) {
        helpers$12.extend(DateAdapter.prototype, members);
      };
      ...
      var core_ticks = {
        ...
        formatters: {
          ...
          values: function(value) {
            return helpers$12.isArray(value) ? value : "" + value;
          },
          /**
          ...
          linear: function(tickValue, index, ticks) {
            ...
            var logDelta = helpers$12.log10(Math.abs(delta));
            var tickString = "";
            if (tickValue !== 0) {
              var maxTick = Math.max(Math.abs(ticks[0]), Math.abs(ticks[ticks.length - 1]));
              if (maxTick < 1e-4) {
                var logTick = helpers$12.log10(Math.abs(tickValue));
          ...
          logarithmic: function(tickValue, index, ticks) {
            var remain = tickValue / Math.pow(10, Math.floor(helpers$12.log10(tickValue)));
            if (tickValue === 0) {
              return "0";
      ...
      var isArray2 = helpers$12.isArray;
      var isNullOrUndef = helpers$12.isNullOrUndef;
      var valueOrDefault$a = helpers$12.valueOrDefault;
      var valueAtIndexOrDefault = helpers$12.valueAtIndexOrDefault;
      ...
      function garbageCollect(caches, length) {
        helpers$12.each(caches, function(cache) {
          var gc = cache.gc;
          var gcLen = gc.length / 2;
          var i;
          if (gcLen > length) {
      ...
      function computeLabelSizes(ctx, tickFonts, ticks, caches) {
        ...
        var i, j, jlen, label, tickFont, fontString, cache, lineHeight, width, height4, nestedLabel, widest, highest;
        for (i = 0; i < length; ++i) {
          label = ticks[i].label;
          ...
          if (!isNullOrUndef(label) && !isArray2(label)) {
            width = helpers$12.measureText(ctx, cache.data, cache.gc, width, label);
            height4 = lineHeight;
          } else if (isArray2(label)) {
            for (j = 0, jlen = label.length; j < jlen; ++j) {
              nestedLabel = label[j];
              if (!isNullOrUndef(nestedLabel) && !isArray2(nestedLabel)) {
                width = helpers$12.measureText(ctx, cache.data, cache.gc, width, nestedLabel);
                height4 += lineHeight;
              }
            }
          }
          widths.push(width);
          heights.push(height4);
          offsets.push(lineHeight / 2);
          widestLabelSize = Math.max(width, widestLabelSize);
          highestLabelSize = Math.max(height4, highestLabelSize);
        }
      ...
      function getScaleLabelHeight(options2) {
        ...
        font = helpers$12.options._parseFont(options2);
        padding = helpers$12.options.toPadding(options2.padding);
        return font.lineHeight + padding.height;
      }
      function parseFontOptions(options2, nestedOpts) {
        return helpers$12.extend(helpers$12.options._parseFont({
          ...
          color: helpers$12.options.resolve([nestedOpts.fontColor, options2.fontColor, core_defaults.global.defaultFontColor])
        });
      }
      ...
      function calculateSpacing(majorIndices, ticks, axisLength, ticksLimit) {
        ...
        factors = helpers$12.math._factorize(evenMajorSpacing);
      ...
      var Scale = core_element.extend({
        ...
        */
        ...
        beforeUpdate: function() {
          helpers$12.callback(this.options.beforeUpdate, [this]);
        },
        /**
        ...
        afterUpdate: function() {
          helpers$12.callback(this.options.afterUpdate, [this]);
        },
        //
        beforeSetDimensions: function() {
          helpers$12.callback(this.options.beforeSetDimensions, [this]);
        },
        ...
        afterSetDimensions: function() {
          helpers$12.callback(this.options.afterSetDimensions, [this]);
        },
        // Data limits
        beforeDataLimits: function() {
          helpers$12.callback(this.options.beforeDataLimits, [this]);
        },
        determineDataLimits: helpers$12.noop,
        afterDataLimits: function() {
          helpers$12.callback(this.options.afterDataLimits, [this]);
        },
        //
        beforeBuildTicks: function() {
          helpers$12.callback(this.options.beforeBuildTicks, [this]);
        },
        buildTicks: helpers$12.noop,
        afterBuildTicks: function(ticks) {
          var me = this;
          if (isArray2(ticks) && ticks.length) {
            return helpers$12.callback(me.options.afterBuildTicks, [me, ticks]);
          }
          me.ticks = helpers$12.callback(me.options.afterBuildTicks, [me, me.ticks]) || me.ticks;
          return ticks;
        },
        beforeTickToLabelConversion: function() {
          helpers$12.callback(this.options.beforeTickToLabelConversion, [this]);
        },
        ...
        afterTickToLabelConversion: function() {
          helpers$12.callback(this.options.afterTickToLabelConversion, [this]);
        },
        //
        beforeCalculateTickRotation: function() {
          helpers$12.callback(this.options.beforeCalculateTickRotation, [this]);
        },
        calculateTickRotation: function() {
          ...
          if (maxLabelWidth + 6 > tickWidth) {
            ...
            labelRotation = helpers$12.toDegrees(Math.min(
        ...
        afterCalculateTickRotation: function() {
          helpers$12.callback(this.options.afterCalculateTickRotation, [this]);
        },
        //
        beforeFit: function() {
          helpers$12.callback(this.options.beforeFit, [this]);
        },
        fit: function() {
          var me = this;
          ...
          if (tickOpts.display && display) {
            ...
            if (isHorizontal) {
              ...
              var angleRadians = helpers$12.toRadians(me.labelRotation);
        ...
        afterFit: function() {
          helpers$12.callback(this.options.afterFit, [this]);
        },
        // Shared Methods
        ...
        */
         ...
         * @param datasetIndex
         */
        getLabelForIndex: helpers$12.noop,
        /**
         ...
         * @param datasetIndex
         */
        getPixelForValue: helpers$12.noop,
        /**
         * Used to get the data value from a given pixel. This is the inverse of getPixelForValue
         * The coordinate (0, 0) is at the upper-left corner of the canvas
         * @param pixel
         */
        getValueForPixel: helpers$12.noop,
        /**
        ...
        _autoSkip: function(ticks) {
          ...
          if (numMajorIndices > 0) {
            ...
            skip(ticks, spacing, helpers$12.isNullOrUndef(avgMajorSpacing) ? 0 : first - avgMajorSpacing, first);
            skip(ticks, spacing, last, helpers$12.isNullOrUndef(avgMajorSpacing) ? ticks.length : last + avgMajorSpacing);
            return nonSkipped(ticks);
          }
          skip(ticks, spacing);
          return nonSkipped(ticks);
        ...
        _tickSize: function() {
          ...
          var rot = helpers$12.toRadians(me.labelRotation);
        ...
        _computeGridLineItems: function(chartArea) {
          ...
          var alignPixel = helpers$12._alignPixel;
        ...
        _computeLabelItems: function() {
          ...
          var rotation = -helpers$12.toRadians(me.labelRotation);
          var items = [];
        ...
        _drawTitle: function() {
          ...
          var scaleLabelFont = helpers$12.options._parseFont(scaleLabel);
          var scaleLabelPadding = helpers$12.options.toPadding(scaleLabel.padding);
      ...
      var isNullOrUndef$1 = helpers$12.isNullOrUndef;
      var defaultConfig = {
        position: "bottom"
      };
      var scale_category = core_scale.extend({
        ...
        getPixelForValue: function(value, index, datasetIndex) {
          ...
          if (valueCategory !== void 0 || value !== void 0 && isNaN(index)) {
            ...
            value = helpers$12.valueOrDefault(valueCategory, value);
      ...
      var noop = helpers$12.noop;
      var isNullOrUndef$2 = helpers$12.isNullOrUndef;
      function generateTicks(generationOptions, dataRange) {
        ...
        var spacing = helpers$12.niceNum((rmax - rmin) / maxNumSpaces / unit) * unit;
        ...
        if (numSpaces > maxNumSpaces) {
          spacing = helpers$12.niceNum(numSpaces * spacing / maxNumSpaces / unit) * unit;
        }
        if (stepSize || isNullOrUndef$2(precision)) {
          factor = Math.pow(10, helpers$12._decimalPlaces(spacing));
        } else {
        ...
        if (stepSize) {
          if (!isNullOrUndef$2(min2) && helpers$12.almostWhole(min2 / spacing, spacing / 1e3)) {
            niceMin = min2;
          }
          if (!isNullOrUndef$2(max2) && helpers$12.almostWhole(max2 / spacing, spacing / 1e3)) {
            niceMax = max2;
          }
        }
        numSpaces = (niceMax - niceMin) / spacing;
        if (helpers$12.almostEquals(numSpaces, Math.round(numSpaces), spacing / 1e3)) {
      ...
      var scale_linearbase = core_scale.extend({
        ...
        handleTickRangeOptions: function() {
          ...
          if (tickOpts.beginAtZero) {
            var minSign = helpers$12.sign(me.min);
            var maxSign = helpers$12.sign(me.max);
        ...
        buildTicks: function() {
          ...
          var numericGeneratorOptions = {
            ...
            stepSize: helpers$12.valueOrDefault(tickOpts.fixedStepSize, tickOpts.stepSize)
          };
          var ticks = me.ticks = generateTicks(numericGeneratorOptions, me);
          me.handleDirectionalChanges();
          me.max = helpers$12.max(ticks);
          me.min = helpers$12.min(ticks);
          if (tickOpts.reverse) {
            ticks.reverse();
            me.start = me.max;
            me.end = me.min;
      ...
      var scale_linear = scale_linearbase.extend({
        determineDataLimits: function() {
          ...
          helpers$12.each(stacks, function(stackValues) {
            values = stackValues.pos.concat(stackValues.neg);
            me.min = Math.min(me.min, helpers$12.min(values));
            me.max = Math.max(me.max, helpers$12.max(values));
          });
          me.min = helpers$12.isFinite(me.min) && !isNaN(me.min) ? me.min : DEFAULT_MIN;
          me.max = helpers$12.isFinite(me.max) && !isNaN(me.max) ? me.max : DEFAULT_MAX;
        ...
        _computeTickLimit: function() {
          ...
          tickFont = helpers$12.options._parseFont(me.options.ticks);
      ...
      var valueOrDefault$b = helpers$12.valueOrDefault;
      var log10 = helpers$12.math.log10;
      ...
      function nonNegativeOrDefault(value, defaultValue) {
        return helpers$12.isFinite(value) && value >= 0 ? value : defaultValue;
      }
      var scale_logarithmic = core_scale.extend({
        determineDataLimits: function() {
          ...
          if (opts.stacked || hasStacks) {
            ...
            helpers$12.each(valuesPerStack, function(valuesForType) {
              if (valuesForType.length > 0) {
                var minVal = helpers$12.min(valuesForType);
                var maxVal = helpers$12.max(valuesForType);
          ...
          me.min = helpers$12.isFinite(me.min) ? me.min : null;
          me.max = helpers$12.isFinite(me.max) ? me.max : null;
          me.minNotZero = helpers$12.isFinite(me.minNotZero) ? me.minNotZero : null;
      ...
      var valueOrDefault$c = helpers$12.valueOrDefault;
      var valueAtIndexOrDefault$1 = helpers$12.valueAtIndexOrDefault;
      var resolve$4 = helpers$12.options.resolve;
      var defaultConfig$3 = {
        display: true,
      ...
      function measureLabelSize(ctx, lineHeight, label) {
        if (helpers$12.isArray(label)) {
          return {
            w: helpers$12.longestText(ctx, ctx.font, label),
      ...
      function fitWithPointLabels(scale2) {
        var plFont = helpers$12.options._parseFont(scale2.options.pointLabels);
        var furthestLimits = {
          l: 0,
          r: scale2.width,
          t: 0,
        ...
        for (i = 0; i < valueCount; i++) {
          ...
          var angle = helpers$12.toDegrees(angleRadians) % 360;
      ...
      function drawPointLabels(scale2) {
        ...
        var plFont = helpers$12.options._parseFont(pointLabelOpts);
        ctx.save();
        ...
        for (var i = scale2.chart.data.labels.length - 1; i >= 0; i--) {
          ...
          var angleRadians = scale2.getIndexAngle(i);
          var angle = helpers$12.toDegrees(angleRadians);
      ...
      function numberOrZero(param) {
        return helpers$12.isNumber(param) ? param : 0;
      }
      var scale_radialLinear = scale_linearbase.extend({
        ...
        determineDataLimits: function() {
          ...
          helpers$12.each(chart.data.datasets, function(dataset, datasetIndex) {
            if (chart.isDatasetVisible(datasetIndex)) {
              var meta = chart.getDatasetMeta(datasetIndex);
              helpers$12.each(dataset.data, function(rawValue, index) {
        ...
        convertTicksToLabels: function() {
          ...
          me.pointLabels = me.chart.data.labels.map(function() {
            var label = helpers$12.callback(me.options.pointLabels.callback, arguments, me);
        ...
        _drawGrid: function() {
          ...
          if (gridLineOpts.display) {
            helpers$12.each(me.ticks, function(label, index) {
              if (index !== 0) {
        ...
        _drawLabels: function() {
          ...
          var tickFont = helpers$12.options._parseFont(tickOpts);
         ...
         * @private
         */
        _drawTitle: helpers$12.noop
      });
      var _defaults$3 = defaultConfig$3;
      scale_radialLinear._defaults = _defaults$3;
      var deprecated$1 = helpers$12._deprecated;
      var resolve$5 = helpers$12.options.resolve;
      var valueOrDefault$d = helpers$12.valueOrDefault;
      ...
      function getMin(options2) {
        return helpers$12.valueOrDefault(options2.time.min, options2.ticks.min);
      }
      function getMax(options2) {
        return helpers$12.valueOrDefault(options2.time.max, options2.ticks.max);
      }
      ...
      function parse(scale2, input) {
        if (helpers$12.isNullOrUndef(input)) {
          return null;
        }
        var options2 = scale2.options.time;
      ...
      var scale_time = core_scale.extend({
        ...
        update: function() {
          ...
          helpers$12.mergeIf(time.displayFormats, adapter.formats());
        ...
        _getLabelSize: function(label) {
          ...
          var angle = helpers$12.toRadians(me.isHorizontal() ? ticksOpts.maxRotation : ticksOpts.minRotation);
      ...
      var mappers = {
        ...
        boundary: function(source) {
          ...
          if (helpers$12.isArray(boundary)) {
      ...
      function drawArea(ctx, curve0, curve1, len0, len1) {
        ...
        for (i = 1; i < len0; ++i) {
          helpers$12.canvas.lineTo(ctx, curve0[i - 1], curve0[i]);
        }
        ...
        for (i = len1 - 1; i > 0; --i) {
          helpers$12.canvas.lineTo(ctx, curve1[i], curve1[i - 1], true);
        }
      }
      ...
      var plugin_filler = {
        ...
        afterDatasetsUpdate: function(chart, options2) {
          ...
          for (i = 0; i < count; ++i) {
            ...
            el = meta.dataset;
            source = null;
            if (el && el._model && el instanceof elements2.Line) {
              source = {
        ...
        beforeDatasetsDraw: function(chart) {
          ...
          for (i = metasets.length - 1; i >= 0; --i) {
            ...
            if (mapper && color && points.length) {
              helpers$12.canvas.clipArea(ctx, chart.chartArea);
              doFill(ctx, points, mapper, view, color, el._loop);
              helpers$12.canvas.unclipArea(ctx);
            }
          }
        }
      };
      var getRtlHelper$1 = helpers$12.rtl.getRtlAdapter;
      var noop$1 = helpers$12.noop;
      var valueOrDefault$e = helpers$12.valueOrDefault;
      core_defaults._set("global", {
        legend: {
          display: true,
          position: "top",
      ...
      var Legend = core_element.extend({
        ...
        buildLabels: function() {
          ...
          var legendItems = helpers$12.callback(labelOpts.generateLabels, [me.chart], me) || [];
          if (labelOpts.filter) {
        ...
        fit: function() {
          ...
          var ctx = me.ctx;
          var labelFont = helpers$12.options._parseFont(labelOpts);
          ...
          if (isHorizontal) {
            ...
            ctx.textAlign = "left";
            ctx.textBaseline = "middle";
            helpers$12.each(me.legendItems, function(legendItem, i) {
        ...
        draw: function() {
          ...
          var drawLegendBox = function(x, y, legendItem) {
            ...
            if (labelOpts && labelOpts.usePointStyle) {
              ...
              helpers$12.canvas.drawPoint(ctx, legendItem.pointStyle, radius, centerX, centerY, legendItem.rotation);
            } else {
          ...
          helpers$12.rtl.overrideTextDirection(me.ctx, opts.textDirection);
          ...
          helpers$12.rtl.restoreTextDirection(me.ctx, opts.textDirection);
        },
        /**
         * @private
         */
      ...
      var plugin_legend = {
        ...
        beforeUpdate: function(chart) {
          ...
          if (legendOpts) {
            helpers$12.mergeIf(legendOpts, core_defaults.global.legend);
            if (legend2) {
              core_layouts.configure(chart, legend2, legendOpts);
      ...
      var Title = core_element.extend({
        ...
        fit: function() {
          ...
          lineCount = helpers$12.isArray(opts.text) ? opts.text.length : 1;
          textSize = lineCount * helpers$12.options._parseFont(opts).lineHeight + opts.padding * 2;
        ...
        draw: function() {
          ...
          var fontOpts = helpers$12.options._parseFont(opts);
          ...
          ctx.fillStyle = helpers$12.valueOrDefault(opts.fontColor, core_defaults.global.defaultFontColor);
      ...
      var plugin_title = {
        ...
        beforeUpdate: function(chart) {
          ...
          if (titleOpts) {
            helpers$12.mergeIf(titleOpts, core_defaults.global.title);
            if (titleBlock) {
      ...
      plugins.title = title;
      core_controller.helpers = helpers$12;
      core_helpers();
      core_controller._adapters = core_adapters;
      core_controller.Animation = core_animation;
      core_controller.animationService = core_animations;
      core_controller.controllers = controllers2;
      core_controller.DatasetController = core_datasetController;
      core_controller.defaults = core_defaults;
      core_controller.Element = core_element;
      core_controller.elements = elements2;
...
// node_modules/chartjs-chart-box-and-violin-plot/build/Chart.BoxPlot.esm.js
...
function quantiles(d, quantiles2) {
  d = d.slice().sort(ascending);
  var n_1 = d.length - 1;
  return quantiles2.map(function(q) {
    if (q === 0) return d[0];
...
function kde() {
  var kernel = gaussian, sample = [], bandwidth = nrd;
  function kde2(points, i) {
    var bw = bandwidth.call(this, sample);
    return points.map(function(x) {
      var i2 = -1, y = 0, n = sample.length;
      while (++i2 < n) {
        y += kernel((x - sample[i2]) / bw);
      }
      return [x, y / bw / n];
    });
  }
  kde2.kernel = function(x) {
    if (!arguments.length) return kernel;
    kernel = x;
    return kde2;
  };
  kde2.sample = function(x) {
    if (!arguments.length) return sample;
    sample = x;
    return kde2;
  };
  kde2.bandwidth = function(x) {
...
function quantilesType7(arr) {
  var n1 = arr.length - 1;
  var compute = function compute2(q) {
    var index = 1 + q * n1;
...
function fivenum(arr) {
  ...
  var compute = function compute2(d) {
...
function whiskers(boxplot2, arr) {
  var coef = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 1.5;
  var iqr2 = boxplot2.q3 - boxplot2.q1;
  var coefValid = typeof coef === "number" && coef > 0;
  var whiskerMin = coefValid ? Math.max(boxplot2.min, boxplot2.q1 - coef * iqr2) : boxplot2.min;
  var whiskerMax = coefValid ? Math.min(boxplot2.max, boxplot2.q3 + coef * iqr2) : boxplot2.max;
...
function determineStatsOptions(options) {
  ...
  var quantiles2 = typeof q === "function" ? q : q === "hinges" || q === "fivenum" ? fivenum : quantilesType7;
  return {
    coef,
...
function boxplotStats(arr, options) {
  ...
  var _determineStatsOption = determineStatsOptions(options), quantiles2 = _determineStatsOption.quantiles, coef = _determineStatsOption.coef;
  var stats = quantiles2(arr);
  var _whiskers = whiskers(stats, arr, coef), whiskerMin = _whiskers.whiskerMin, whiskerMax = _whiskers.whiskerMax;
...
function violinStats(arr, options) {
  ...
  var _determineStatsOption2 = determineStatsOptions(options), quantiles2 = _determineStatsOption2.quantiles;
  var stats = quantiles2(arr);
...
function asBoxPlotStats(value, options) {
  ...
  if (typeof value.median === "number" && typeof value.q1 === "number" && typeof value.q3 === "number") {
    if (typeof value.whiskerMin === "undefined") {
      var _determineStatsOption3 = determineStatsOptions(options), coef = _determineStatsOption3.coef;
      var _whiskers2 = whiskers(value, Array.isArray(value.items) ? value.items.slice().sort(function(a, b) {
        return a - b;
      }) : null, coef), whiskerMin = _whiskers2.whiskerMin, whiskerMax = _whiskers2.whiskerMax;
...
function commonDataLimits(extraCallback) {
  ...
  var _this$options$ticks = this.options.ticks, minStats = _this$options$ticks.minStats, maxStats = _this$options$ticks.maxStats;
  var matchID = function matchID2(meta) {
...
var defaults2 = _objectSpread2(_objectSpread2({}, import_chart.defaults.global.elements.rectangle), {}, {
  borderWidth: 1,
  outlierRadius: 2,
  outlierColor: import_chart.defaults.global.elements.rectangle.backgroundColor,
  lowerColor: import_chart.defaults.global.elements.rectangle.lowerColor,
  medianColor: null,
  itemRadius: 0,
  itemStyle: "circle",
  itemBackgroundColor: import_chart.defaults.global.elements.rectangle.backgroundColor,
  itemBorderColor: import_chart.defaults.global.elements.rectangle.borderColor,
  hitPadding: 2,
  outlierHitRadius: 4,
  tooltipDecimals: 2
});
var ArrayElementBase = import_chart.Element.extend({
  isVertical: function isVertical() {
    return this._view.width !== void 0;
  },
  draw: function draw() {
  },
  _drawItems: function _drawItems(vm, container, ctx, vert) {
    ...
    var random = rnd(this._datasetIndex * 1e3 + this._index);
    if (vert) {
      container.items.forEach(function(v) {
        import_chart.canvasHelpers.drawPoint(ctx, vm.itemStyle, vm.itemRadius, vm.x - vm.width / 2 + random() * vm.width, v);
      });
    } else {
      container.items.forEach(function(v) {
        import_chart.canvasHelpers.drawPoint(ctx, vm.itemStyle, vm.itemRadius, v, vm.y - vm.height / 2 + random() * vm.height);
      });
    }
    ctx.restore();
  },
  ...
  getCenterPoint: function getCenterPoint() {
    var _this$_view = this._view, x = _this$_view.x, y = _this$_view.y;
    return {
      x,
      y
    };
...
import_chart.defaults.global.elements.boxandwhiskers = _objectSpread2({}, defaults2);
...
var BoxAndWiskers = import_chart.elements.BoxAndWhiskers = ArrayElementBase.extend({
  transition: function transition(ease) {
    var r = import_chart.Element.prototype.transition.call(this, ease);
    ...
    if (model.boxplot === view.boxplot) {
      view.boxplot = import_chart.helpers.clone(view.boxplot);
    }
  ...
  draw: function draw2() {
    var ctx = this._chart.ctx;
    var vm = this._view;
    var boxplot2 = vm.boxplot;
    var vert = this.isVertical();
    ctx.save();
    ctx.fillStyle = vm.backgroundColor;
    ctx.strokeStyle = vm.borderColor;
    ctx.lineWidth = vm.borderWidth;
    this._drawBoxPlot(vm, boxplot2, ctx, vert);
    this._drawOutliers(vm, boxplot2, ctx, vert);
    ctx.restore();
    this._drawItems(vm, boxplot2, ctx, vert);
  },
  _drawBoxPlot: function _drawBoxPlot(vm, boxplot2, ctx, vert) {
    if (vert) {
      this._drawBoxPlotVert(vm, boxplot2, ctx);
    } else {
      this._drawBoxPlotHoriz(vm, boxplot2, ctx);
    }
  },
  _drawBoxPlotVert: function _drawBoxPlotVert(vm, boxplot2, ctx) {
    var x = vm.x;
    var width = vm.width;
    var x0 = x - width / 2;
    if (boxplot2.q3 > boxplot2.q1) {
      ctx.fillRect(x0, boxplot2.q1, width, boxplot2.q3 - boxplot2.q1);
    } else {
      ctx.fillRect(x0, boxplot2.q3, width, boxplot2.q1 - boxplot2.q3);
    }
    ctx.save();
    if (vm.medianColor) {
    ...
    ctx.beginPath();
    ctx.moveTo(x0, boxplot2.median);
    ctx.lineTo(x0 + width, boxplot2.median);
    ctx.closePath();
    ctx.stroke();
    if (boxplot2.segment != null) {
      if (vm.segmentColor) {
        ctx.strokeStyle = vm.segmentColor;
      }
      ctx.beginPath();
      ctx.moveTo(x0, boxplot2.segment);
      ctx.lineTo(x0 + width, boxplot2.segment);
      ctx.closePath();
    }
    if (vm.lowerColor) {
      ctx.fillStyle = vm.lowerColor;
      if (boxplot2.q3 > boxplot2.q1) {
        ctx.fillRect(x0, boxplot2.median, width, boxplot2.q3 - boxplot2.median);
      } else {
        ctx.fillRect(x0, boxplot2.median, width, boxplot2.q1 - boxplot2.median);
      }
    }
    ctx.closePath();
    ctx.stroke();
    ctx.restore();
    if (boxplot2.q3 > boxplot2.q1) {
      ctx.strokeRect(x0, boxplot2.q1, width, boxplot2.q3 - boxplot2.q1);
    } else {
      ctx.strokeRect(x0, boxplot2.q3, width, boxplot2.q1 - boxplot2.q3);
    }
    ctx.beginPath();
    ctx.moveTo(x0, boxplot2.whiskerMin);
    ctx.lineTo(x0 + width, boxplot2.whiskerMin);
    ctx.moveTo(x, boxplot2.whiskerMin);
    ctx.lineTo(x, boxplot2.q1);
    ctx.moveTo(x0, boxplot2.whiskerMax);
    ctx.lineTo(x0 + width, boxplot2.whiskerMax);
    ctx.moveTo(x, boxplot2.whiskerMax);
    ctx.lineTo(x, boxplot2.q3);
    ctx.closePath();
    ctx.stroke();
  },
  _drawBoxPlotHoriz: function _drawBoxPlotHoriz(vm, boxplot2, ctx) {
    var y = vm.y;
    var height4 = vm.height;
    var y0 = y - height4 / 2;
    if (boxplot2.q3 > boxplot2.q1) {
      ctx.fillRect(boxplot2.q1, y0, boxplot2.q3 - boxplot2.q1, height4);
    } else {
      ctx.fillRect(boxplot2.q3, y0, boxplot2.q1 - boxplot2.q3, height4);
    }
    ctx.save();
    if (vm.medianColor) {
      ctx.strokeStyle = vm.medianColor;
    ...
    ctx.beginPath();
    ctx.moveTo(boxplot2.median, y0);
    ctx.lineTo(boxplot2.median, y0 + height4);
    ctx.closePath();
    ctx.stroke();
    ctx.restore();
    if (boxplot2.q3 > boxplot2.q1) {
      ctx.strokeRect(boxplot2.q1, y0, boxplot2.q3 - boxplot2.q1, height4);
    } else {
      ctx.strokeRect(boxplot2.q3, y0, boxplot2.q1 - boxplot2.q3, height4);
    }
    ctx.beginPath();
    ctx.moveTo(boxplot2.whiskerMin, y0);
    ctx.lineTo(boxplot2.whiskerMin, y0 + height4);
    ctx.moveTo(boxplot2.whiskerMin, y);
    ctx.lineTo(boxplot2.q1, y);
    ctx.moveTo(boxplot2.whiskerMax, y0);
    ctx.lineTo(boxplot2.whiskerMax, y0 + height4);
    ctx.moveTo(boxplot2.whiskerMax, y);
    ctx.lineTo(boxplot2.q3, y);
    ctx.closePath();
    ctx.stroke();
  },
  _getBounds: function _getBounds2() {
    var vm = this._view;
    var vert = this.isVertical();
    var boxplot2 = vm.boxplot;
    if (!boxplot2) {
    ...
    if (vert) {
      var x = vm.x, width = vm.width;
      var x0 = x - width / 2;
      return {
        left: x0,
        top: boxplot2.whiskerMax,
        right: x0 + width,
        bottom: boxplot2.whiskerMin
      };
    }
    var y = vm.y, height4 = vm.height;
    var y0 = y - height4 / 2;
    return {
      left: boxplot2.whiskerMin,
      top: y0,
      right: boxplot2.whiskerMax,
      bottom: y0 + height4
    };
  },
  ...
  getArea: function getArea2() {
    var vm = this._view;
    var iqr2 = Math.abs(vm.boxplot.q3 - vm.boxplot.q1);
    if (this.isVertical()) {
      return iqr2 * vm.width;
    }
    return iqr2 * vm.height;
  },
  _getOutliers: function _getOutliers2() {
    return this._view.boxplot ? this._view.boxplot.outliers || [] : [];
  }
});
import_chart.defaults.global.elements.violin = _objectSpread2({
  points: 100
}, defaults2);
...
var Violin = import_chart.elements.Violin = ArrayElementBase.extend({
  transition: function transition2(ease) {
    var r = import_chart.Element.prototype.transition.call(this, ease);
    var model = this._model;
    var start = this._start;
    var view = this._view;
    ...
    if (model.violin === view.violin) {
      view.violin = import_chart.helpers.clone(view.violin);
    }
  ...
  draw: function draw3() {
    ...
    import_chart.canvasHelpers.drawPoint(ctx, "rectRot", 5, vm.x, vm.y);
    ctx.stroke();
    ctx.beginPath();
    if (vert) {
      var x = vm.x;
  ...
  _getBounds: function _getBounds3() {
    var vm = this._view;
    var vert = this.isVertical();
    var violin = vm.violin;
    if (vert) {
  ...
  height: function height3() {
    var vm = this._view;
    return vm.base - Math.min(vm.violin.min, vm.violin.max);
  },
  getArea: function getArea3() {
    var vm = this._view;
    var iqr2 = Math.abs(vm.violin.max - vm.violin.min);
    if (this.isVertical()) {
      return iqr2 * vm.width;
    }
    return iqr2 * vm.height;
  },
  _getOutliers: function _getOutliers3() {
...
function toFixed(value) {
  var decimals = this._chart.config.options.tooltipDecimals;
...
var array = {
  ...
  updateElement: function updateElement(elem, index, reset) {
    ...
    import_chart.controllers.bar.prototype.updateElement.call(this, elem, index, reset);
    var resolve = import_chart.helpers.options.resolve;
    var context = {
      chart: this.chart,
      dataIndex: index,
      dataset,
  ...
  setHoverStyle: function setHoverStyle(element) {
    import_chart.controllers.bar.prototype.setHoverStyle.call(this, element);
    var dataset = this.chart.data.datasets[element._datasetIndex];
    var index = element._index;
    var custom = element.custom || {};
    var model = element._model;
    var getHoverColor = import_chart.helpers.getHoverColor;
    var resolve = import_chart.helpers.options.resolve;
    configKeys.forEach(function(item, i) {
      ...
      element._model[item] = resolve([custom[hoverKey], dataset[hoverKey], modelValue], void 0, index);
    });
  }
};
...
import_chart.defaults.boxplot = import_chart.helpers.merge({}, [import_chart.defaults.bar, verticalDefaults, defaults$1]);
import_chart.defaults.horizontalBoxplot = import_chart.helpers.merge({}, [import_chart.defaults.horizontalBar, horizontalDefaults, defaults$1]);
if (import_chart.defaults.global.datasets && import_chart.defaults.global.datasets.bar) {
  import_chart.defaults.global.datasets.boxplot = _objectSpread2({}, import_chart.defaults.global.datasets.bar);
}
if (import_chart.defaults.global.datasets && import_chart.defaults.global.datasets.horizontalBar) {
  import_chart.defaults.global.datasets.horizontalBoxplot = _objectSpread2({}, import_chart.defaults.global.datasets.horizontalBar);
}
var boxplot = _objectSpread2(_objectSpread2({}, array), {}, {
  dataElementType: import_chart.elements.BoxAndWhiskers,
  _elementOptions: function _elementOptions2() {
  ...
  _updateElementGeometry: function _updateElementGeometry(elem, index, reset) {
    ...
    (_Chart$controllers$ba = import_chart.controllers.bar.prototype._updateElementGeometry).call.apply(_Chart$controllers$ba, [this, elem, index, reset].concat(args));
...
var BoxPlot = import_chart.controllers.boxplot = import_chart.controllers.bar.extend(boxplot);
var HorizontalBoxPlot = import_chart.controllers.horizontalBoxplot = import_chart.controllers.horizontalBar.extend(boxplot);
...
import_chart.defaults.violin = import_chart.helpers.merge({}, [import_chart.defaults.bar, verticalDefaults, defaults$2]);
import_chart.defaults.horizontalViolin = import_chart.helpers.merge({}, [import_chart.defaults.horizontalBar, horizontalDefaults, defaults$2]);
if (import_chart.defaults.global.datasets && import_chart.defaults.global.datasets.bar) {
  import_chart.defaults.global.datasets.violin = _objectSpread2({}, import_chart.defaults.global.datasets.bar);
}
if (import_chart.defaults.global.datasets && import_chart.defaults.global.datasets.horizontalBar) {
  import_chart.defaults.global.datasets.horizontalViolin = _objectSpread2({}, import_chart.defaults.global.datasets.horizontalBar);
}
var controller = _objectSpread2(_objectSpread2({}, array), {}, {
  dataElementType: import_chart.elements.Violin,
  _elementOptions: function _elementOptions3() {
    return this.chart.options.elements.violin;
  },
  /**
   * @private
   */
  _updateElementGeometry: function _updateElementGeometry2(elem, index, reset) {
    var _Chart$controllers$ba;
    for (var _len2 = arguments.length, args = new Array(_len2 > 3 ? _len2 - 3 : 0), _key2 = 3; _key2 < _len2; _key2++) {
      args[_key2 - 3] = arguments[_key2];
    }
    ...
    var custom = elem.custom || {};
    var options = this._elementOptions();
    elem._model.violin = this._calculateViolinValuesPixels(this.index, index, custom.points !== void 0 ? custom.points : options.points);
  },
  /**
   * @private
   */
  _calculateViolinValuesPixels: function _calculateViolinValuesPixels(datasetIndex, index, points) {
    ...
    var coords = violin.coords || violin.kde(samples).map(function(v2) {
      return {
        v: v2[0],
        estimate: v2[1]
      };
    ...
    var r = {
      ...
      coords: coords.map(function(_ref) {
        var v2 = _ref.v, estimate = _ref.estimate;
        return {
          v: scale.getPixelForValue(v2),
          estimate
        };
      }),
...
var Violin$1 = import_chart.controllers.violin = import_chart.controllers.bar.extend(controller);
var HorizontalViolin = import_chart.controllers.horizontalViolin = import_chart.controllers.horizontalBar.extend(controller);
var helpers = import_chart.helpers;
var ArrayLinearScaleOptions = helpers.merge({}, [commonScaleOptions, import_chart.scaleService.getScaleDefaults("linear")]);
var ArrayLinearScale = import_chart.scaleService.getScaleConstructor("linear").extend({
  getRightValue: function getRightValue$1(rawValue) {
    return import_chart.LinearScaleBase.prototype.getRightValue.call(this, getRightValue(rawValue, this.options.ticks));
  },
  _parseValue: function _parseValue(rawValue) {
    return import_chart.LinearScaleBase.prototype._parseValue.call(this, getRightValue(rawValue, this.options.ticks));
  },
...
import_chart.scaleService.registerScaleType("arrayLinear", ArrayLinearScale, ArrayLinearScaleOptions);
var helpers$1 = import_chart.helpers;
var ArrayLogarithmicScaleOptions = helpers$1.merge({}, [commonScaleOptions, import_chart.scaleService.getScaleDefaults("logarithmic")]);
var ArrayLogarithmicScale = import_chart.scaleService.getScaleConstructor("logarithmic").extend({
  getRightValue: function getRightValue$12(rawValue) {
    return import_chart.LinearScaleBase.prototype.getRightValue.call(this, getRightValue(rawValue, this.options.ticks));
  },
  _parseValue: function _parseValue2(rawValue) {
    return import_chart.LinearScaleBase.prototype._parseValue.call(this, getRightValue(rawValue, this.options.ticks));
  },
  determineDataLimits: function determineDataLimits2() {
    var _this = this;
...
import_chart.scaleService.registerScaleType("arrayLogarithmic", ArrayLogarithmicScale, ArrayLogarithmicScaleOptions);
function boxplotPositioner(elements2, eventPosition) {
  var _this = this;
  if (!elements2.length) {
    return false;
  }
  var _elements$reduce = elements2.reduce(function(_ref, el) {
    var _ref2 = _slicedToArray(_ref, 3), xi = _ref2[0], ci = _ref2[1], counti = _ref2[2];
    if (el && el.hasValue()) {
      var pos = el.tooltipPosition(eventPosition, _this);
      return [xi + pos.x, ci + pos.y, counti + 1];
    }
    return [xi, ci, counti];
  }, [0, 0, 0]), _elements$reduce2 = _slicedToArray(_elements$reduce, 3), x = _elements$reduce2[0], y = _elements$reduce2[1], count = _elements$reduce2[2];
  return {
    x: x / count,
    y: y / count
  };
}
import_chart.Tooltip.positioners.boxplot = boxplotPositioner;
export {
  ArrayLinearScale,
...
chart.js/dist/Chart.js:
   ...
   *)
*/
//# sourceMappingURL=chartjs-chart-box-and-violin-plot.js.map
